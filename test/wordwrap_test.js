...
describe('wordwrap', function() {
    ...
    it('breaks text with space within limit at space position and skips space.', function() {
      var wrappedText = wordrap('te st',4);
